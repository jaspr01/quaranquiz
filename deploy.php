...
// Project name
set('application', 'quaranquiz');

// Project repository
set('repository', 'git@github.com:jaspr01/quaranquiz.git');
...
// Hosts
host('quaranquiz.duckchip.be')
    ->set('deploy_path', '/home/random/apps/default/{{application}}');    
